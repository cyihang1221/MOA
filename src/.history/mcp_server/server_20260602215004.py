...
@mcp.tool(
    ...
    Parameters:
    - input_file: CSV file containing differential metabolites (required column: kegg_id)
    - output_dir: directory to save enrichment results and plots
    - organism: KEGG organism code (default: ath, not strictly used in compound mode)
