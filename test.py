...
# -------------------------- 创建文件夹 --------------------------
mkdir -p "$output_dir"/{{mzML_centroid,featureXML,consensus}}
...
if __name__ == "__main__":
    ...
    output_dir = "/data2/liuwei/MOA/workspace/data_preprocessing_results"
    metadata_csv = "/data2/liuwei/MOA/workspace/metadata.csv"

    data_preprocessing_openms_impl(input_dir=input_dir, output_dir=output_dir, mass_error_ppm=10.0)
    # peak_detection_openms_impl(input_dir, output_dir)
    # align_retention_time_and_peak_grouping_openms_impl(output_dir, output_dir)
    # export_feature_table_openms_impl(output_dir, output_dir)
