...
(function () {
  ...
  const STRINGS = {
    "zh-CN": {
      ...
      "image.ready": "可拖动标题、文字、箭头和色块；点击原图图例色块可取色，再用颜色控件替换同色系元素。",
      "image.rasterColorPicked": "已选中底图颜色 {color}，请选择新颜色替换同色系元素。",
      "image.rasterColorApplied": "已替换底图中 {count} 个相近颜色像素。",
      "image.plotlyEditorTitle": "编辑图表：{name}",
      "image.plotlyHint": "可直接拖动标题和图例；点击图例项或在下拉框中选择系列，再用颜色块自动替换该系列颜色。",
    ...
    en: {
      ...
      "image.ready": "Drag titles, text, arrows, and color blocks. Click a legend color in the image, then use the color picker to replace matching pixels.",
      "image.rasterColorPicked": "Picked image color {color}. Choose a new color to replace matching elements.",
      "image.rasterColorApplied": "Replaced {count} matching image pixels.",
      "image.plotlyEditorTitle": "Edit chart: {name}",
      "image.plotlyHint": "Drag the title and legend directly. Click a legend item or choose a series, then use the swatch to recolor it.",
