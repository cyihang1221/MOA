...
(function () {
  ...
  const STRINGS = {
    "zh-CN": {
      ...
      "image.ready": "可拖动标题、文字、箭头和色块；选中对象后可改颜色和字号。",
      "image.plotlyEditorTitle": "编辑图表：{name}",
      "image.plotlyHint": "点击图例项，或在下拉框中选择系列，再点击右侧颜色块修改颜色；双击标题可修改标题文字。",
    ...
    en: {
      ...
      "image.ready": "Drag titles, text, arrows, and color blocks. Select an object to change color or size.",
      "image.plotlyEditorTitle": "Edit chart: {name}",
      "image.plotlyHint": "Click a legend item or choose a series below, then use the color swatch. Double-click the title to edit it.",
