"""通过【MS+软件名】关键词获取PMC全文html文本（先获取pmid，再转换为pmc号码，），获取文献，通过标签提取方法部分，去标签，调用LLM分析方法细节并保存结果"""
...
MAX_RESULTS = 200
OUTPUT_DIR = "extracted_paper_method_V3"
...
def main():
    ...
    for idx, keyword in enumerate(KEYWORDS, 1):
        ...
        pubmed_query = f"(mass spectrometry OR mass spectrum OR MS OR LC-MS OR LC-MS/MS OR GC-MS) AND ({keyword})"
